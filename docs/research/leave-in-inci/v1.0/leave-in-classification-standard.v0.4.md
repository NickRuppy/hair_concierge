# Leave-In Research and Classification Standard v0.4 (working draft)

Status: **post-round-3 model-trim draft — nothing is locked**
Document version: `v0.4-draft`
Engine version: `leave-in-inci-v0.4`
Supersedes: `leave-in-inci-v0.3` (`leave-in-classification-standard.v0.3.md`, retained unchanged as the frozen round-3 rule set; `leave-in-classification-standard.v0.2.md` and `leave-in-classification-standard.v0.1.md` remain the frozen round-2 and round-1 sets)
...
```jsonc
{
  "model_version": "leave-in-matching-v0.4",
  "category_standard_version": "leave-in-inci-v0.4",
