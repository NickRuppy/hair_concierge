...
This is the current master ledger for the product-intake stack. It was reconciled on 2026-07-06
after the PR #199 consolidation merged the phase stack, review center, continuity fixes, and the
deep-review P0 fixes into one integration branch.

Source-of-truth rules:

- Use `.worktrees/agent-v2-validator-diet-slice-1-product-facts` on
  `codex/agent-v2-validator-diet-slice-1-product-facts` as the active shipping worktree for PR
  #199.
- Use `.worktrees/product-identity-canonical-correction` only as historical evidence for the
  ...
  both worktrees.
- Treat `.worktrees/product-intake-full-flow-smoke` and `.worktrees/selected-product-facts-card-polish`
  as superseded implementation worktrees. Their dirty states were preserved on
  `archive/*-dirty-2026-07-06` branches; do not port from them automatically.
...
| --- | --- | --- | --- |
| `.worktrees/agent-v2-validator-diet-slice-1-product-facts` | `codex/agent-v2-validator-diet-slice-1-product-facts`; PR #199 integration branch | Active shipping source of truth. Contains the phase stack, review center workspace, continuity fixes, the product-visibility RLS migration rename/drop-policy fix, and the review-app publish lockout. GitHub checks are green as of 2026-07-06. | Final local/user acceptance test run, then merge #199 when approved. After merge, run the explicit Supabase deploy-time migration step (`supabase db push`, with migration-history repair if needed) to apply the renamed visibility policy migration in production. |
| `.worktrees/product-intake-full-flow-smoke` | `codex/product-intake-full-flow-smoke`; superseded smoke worktree | Historical source for the 2026-06-26 to 2026-06-29 smoke, research-ops, and product-assessment work. Its useful changes are now represented in PR #199 or archived on `archive/product-intake-full-flow-smoke-dirty-2026-07-06`. | No ship work expected. Inspect only for historical evidence or a deliberately chosen future follow-up. |
| `.worktrees/product-identity-canonical-correction` | `codex/product-identity-canonical-correction`; PR #182 / canonical identity evidence | Historical source for canonical identity correction plan updates and the replay v2 script/test/results. Relevant ledger updates are imported here and the old PR is superseded by #199. | No ship work expected. Decide later whether to preserve replay tooling or archive it as calibration evidence. |
| `.worktrees/product-intake-intelligence` | `codex/product-intake-intelligence`; PR #172 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-1` | `codex/product-intake-phase-1`; PR #173 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-2` | `codex/product-intake-phase-2`; PR #175 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-3` | `codex/product-intake-phase-3`; PR #177 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-4a-review-core` | `codex/product-intake-phase-4a-review-core`; PR #179 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-4b-ops` | `codex/product-intake-phase-4b-ops`; PR #180 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |
| `.worktrees/product-intake-phase-5` | `codex/product-intake-phase-5`; PR #181 | Superseded by PR #199. | No ship work expected unless a historical audit needs to inspect the old branch. |

Current plan-file status:

| Plan file | Status | Work still needed |
| --- | --- | --- |
| `plans/2026-06-10-product-intake-intelligence.md` | Master ledger and long-form source of truth. This top section is consolidated as of 2026-07-06 for PR #199. | Keep this ledger updated after merge, Supabase deploy-time migration, and worktree/archive cleanup decisions. Detailed legacy checkboxes below may still lag the PR state. |
...
| `plans/2026-06-25-product-lookup-clarification-card.md` | Implemented and included in PR #199. | No implementation work; keep as historical behavior evidence. |
| `plans/2026-06-25-product-selection-architecture-cleanup.md` | Implemented and included in PR #199. | No implementation work; keep as historical behavior evidence. |
| `plans/2026-06-25-product-intake-chat-submit-polish.md` | Implemented and included in PR #199. | No implementation work; keep as historical behavior evidence. |
| `plans/2026-06-26-product-intake-research-ops.md` | Implemented and included in PR #199 with Review Center. Final Supabase catalog writes remain CLI-only through `products:intake:approve-package -- --apply --confirm`; Review Center publish is intentionally blocked. | After merge, run the explicit Supabase deploy/readiness steps before any real approval writes. Daily research automation and one approved apply/confirm test remain optional operator decisions, not merge blockers. |
| `plans/2026-06-28-product-assessment-context-and-lookup.md` | Implemented and included in PR #199, with the pending-product scope regression fixed so unrelated pending products do not block new resolved asks. | No implementation work; keep as historical behavior evidence. |
| `plans/2026-06-29-product-facts-tool-contract.md` | Historical/superseded. The separate `load_product_facts` tool was preserved only in archived dirty branches; PR #199 uses targeted `select_products` grounding for one resolved product instead. | Do not port automatically. Reconsider later only if the shipped `select_products` approach proves insufficient. |
...
1. Continue final testing from `.worktrees/agent-v2-validator-diet-slice-1-product-facts` / PR #199.
2. Treat the old phase PRs (#172, #173, #175, #177, #179, #180, #181, #182) and PR #196 as superseded by #199.
3. Do not reopen archived dirty work unless a concrete follow-up is chosen. The useful archived follow-ups are the link-existing-product flow, canonical-brand approval guard, thickness-aware shampoo fit, card polish variants, and the optional `load_product_facts` refinement.
4. Merge #199 only after the final user/test acceptance pass.
5. After merge, run the explicit Supabase deploy-time step so the renamed visibility migration applies in production; repair remote migration history first if the CLI reports the known out-of-band versions.
6. After #199 is merged and deployed, retire old worktrees and start Review Center from merged `main`.
7. Keep Phase 7 legacy identity cleanup as a separate follow-up PR after production proof.
...
| Phase 5: Assistant And Recommendation Integration   | Implemented and consolidated in PR #199      | `codex/agent-v2-validator-diet-slice-1-product-facts`, PR #199 | The previous PR #181/#182 split is superseded. PR #199 carries the assistant/recommendation integration, product visibility migration renamed to `20260706120000_product_visibility_policy_lifecycle.sql`, owned-product assessment boundary, pending-product scoping, and review-center continuity fixes. The old `load_product_facts` direction is not part of the shipping branch; one-product assessment is grounded through targeted `select_products`. |
| Phase 6: Verification And Shipping Gates            | PR #199 ready for final user/test acceptance | `codex/agent-v2-validator-diet-slice-1-product-facts`, PR #199 | GitHub checks are green as of 2026-07-06. Remaining gates are user acceptance/final test run, merge #199, then the explicit Supabase deploy-time migration step that applies the renamed product-visibility policy migration in production. |
...
7. Phase 5 assistant/recommendation integration. Implemented and consolidated in PR #199.
8. Phase 6 verification and shipping. PR #199 is the single integration PR. Current concrete step: run final user/test acceptance from `.worktrees/agent-v2-validator-diet-slice-1-product-facts`; merge only after approval, then run the explicit Supabase deploy-time migration step.
...
Recommended next steps from the PR #199 integration worktree:

1. Continue in `.worktrees/agent-v2-validator-diet-slice-1-product-facts`.
2. Run the final user/test acceptance pass for PR #199.
3. Merge #199 only after explicit approval.
4. After merge, run the explicit Supabase deploy-time migration step so `20260706120000_product_visibility_policy_lifecycle.sql` closes the production product-visibility leak.
5. Retire old worktrees only after merged `main` is refreshed and the archive branches have been confirmed sufficient.
6. Keep Phase 7 legacy identity cleanup, link-existing-product flow, canonical-brand approval guard, thickness-aware shampoo fit, card-polish variants, and any `load_product_facts` reconsideration as separate follow-up work.
