...
- **R1 — RESOLVED 2026-09-02: coverage tooling already on main.** The scanner-coverage content (readiness oracle, canonical-GTIN guards, executor machinery, migrations through e20) reached main via squash-merged PRs #499/#501; the stale branch/worktree were cleaned up. T5/T6 are unblocked; sole remaining prerequisite is rebasing this worktree onto current main (done before T5 starts).
