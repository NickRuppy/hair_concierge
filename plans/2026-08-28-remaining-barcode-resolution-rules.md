...
- A frozen E10 identifier cohort now contains the 12 exact existing-product candidates marked `candidate_for_existing_product` (12 products / 12 GTINs), fingerprint `e9b803b9d36f7cc41a6a0972958e0f045d5c91668c8b5766c60976a84384f0e3`. A fresh read at `2026-08-31T19:05:53.609Z` found all 12 product snapshots unchanged, zero existing identifier owners and zero unresolved-submission overlaps. The additive E10 executor migration and PGlite apply/replay/rollback tests are prepared, but neither migration nor data batch has been applied. Thirteen variant/formulation candidates and all reopened-oil candidates remain outside E10.
