...
| L'Oréal Paris Elvital | Shampoo Dream Length | 1000 ml | ❌ none yet | dm | 2221 reviews; promoted from backlog 2026-09-02 (Glycolic Gloss shampoo turned out to already exist in catalog — see Corrections) |
...
| Being (ZURU) | Big Hair Shampoo | 354 ml | ⚠️ 4895248005872 (URL-derived, unverified) | rossmann | **rossmann_new** — brand-new 2026 Rossmann-exclusive line |
| Schwarzkopf Gliss | Sealing Shampoo Sealing Miracle | 200 ml | ❌ none | rossmann | **rossmann_new** — explicitly tagged "Neu", homepage promo banner |
...
| L'Oréal Paris Elvital | Conditioner Bond Repair Anti-Haarschäden | 150 ml | ❌ page had it, capture got truncated | dm | 723 reviews |
| Being (ZURU) | Big Hair Conditioner | 354 ml | ❌ none | rossmann | **rossmann_new** — pairs with pilot shampoo |
...
| Herbal Essences | Haarmaske Blütensanft | 300 ml | ❌ none | rossmann | 1211 reviews, completes Blütensanft line |
| Schwarzkopf Gliss | Haarkur 7sec Express-Repair, Ultimate Repair | 200 ml | ✅ 4015100813319 | dm | 992 reviews, fast-format |
| IDA WARG Beauty | Intense Moisture Hair Mask | 250 ml | ❌ none | rossmann | **rossmann_new** — new premium Swedish brand |
...
| L'Oréal Paris Elvital | Leave-In Haarserum Bond Repair, Anti-Haarschäden | 150 ml | ❌ none yet | dm | 800 reviews; promoted from backlog 2026-09-02 (head&shoulders Derma x Pro reclassified as scalp_care and parked — Nick's call, it's a Kopfhaut-Serum, not hair care) |
| Garnier Fructis | Leave-In Creme Aloe Air Dry | 400 ml | ✅ 3600542117593 | dm | 959 reviews (see gaps note on possible catalog overlap below) |
| Being (ZURU) | Major Moisture Leave-In Conditioner | 227 ml | ❌ none | rossmann | **rossmann_new** |
...
| Isana Professional | Haaröl Arganöl & Pflege | 100 ml | ❌ none | rossmann | 406 reviews, Rossmann private label pick |
| Monday Haircare | Repair Argan Haaröl | 89 ml | ❌ none | rossmann | **rossmann_new** — explicitly tagged "Neu" |
...
- **EAN coverage — pilot: 21/30 (70%) have at least one confirmed EAN**, all sourced directly from a `GTIN:` field on the retailer's own product page (dm.de) or, in one case (Being Big Hair Shampoo), inferred from a product-page URL pattern that needs a quick manual double-check. The 9 pilot items without an EAN are exactly the Rossmann-only items whose product cards weren't reachable as plain links in this pass (Gliss Sealing Miracle, Being Big Hair Conditioner, Being Major Moisture Leave-In, IDA WARG mask, Herbal Essences mask, Isana Professional oil, Monday Haircare oil) plus one dm item (Elvital Bond Repair Conditioner) where the GTIN was on the page but got cut off mid-capture and needs a 30-second re-check.
...
- **No invented EANs anywhere** — every EAN in this file was either read directly off a retailer product page (`GTIN:` field) or is explicitly marked ⚠️/unverified with its source noted; empty `eans: []` means "not found yet," never "doesn't exist."
