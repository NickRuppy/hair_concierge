...
test("organic offer renders the approved calm hierarchy with exactly one supplied pricing slot", () => {
  ...
  assert.match(html, /<wistia-player[^>]*media-id="nwrpfub965"/)
  assert.match(html, /<wistia-player[^>]*aspect="1\.7777777777777777"/)
  assert.match(html, /<wistia-player[^>]*autoplay="true"/)
  assert.match(html, /<wistia-player[^>]*preload="auto"/)
  assert.match(html, /<wistia-player[^>]*silent-autoplay="true"/)
  assert.doesNotMatch(html, /<wistia-player[^>]*\smuted(?:=|\s|>)/)
