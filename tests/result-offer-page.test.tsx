...
test("result offer page shell renders the unified diagnostic offer sections and live pricing copy", () => {
  ...
  // Anchor (strikethrough) prices still appear in the rendered markup
  ...
  // Discounted prices (what we actually charge after the Stripe coupon)
  assert.match(html, /€7,49/i)
  assert.match(html, /€17,49/i)
  assert.match(html, /€49,99/i)
  assert.match(html, /Jetzt starten — €17,49 im Quartal/i)
