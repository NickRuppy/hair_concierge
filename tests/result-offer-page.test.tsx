...
test("paid legacy result projects new organic ids into the established result narrative", () => {
  const html = renderToStaticMarkup(
    <ResultPageClient
      ...
      quizAnswers={{
        ...quizAnswers,
        concerns: ["frizz_flyaways"],
        goals: ["frizz_surface"],
      }}
    />,
  )

  assert.match(html, /Frizz/i)
  assert.match(html, /Geschmeidigkeit &amp; Kontrolle/i)
})
