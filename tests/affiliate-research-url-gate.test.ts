...
test("isAllowedHost matches with or without www. prefix", () => {
  ...
  assert.equal(isAllowedHost("hagel-shop.de"), true)
  assert.equal(isAllowedHost("www.shop-apotheke.com"), true)
  assert.equal(isAllowedHost("epres-hair.de"), true)
  assert.equal(isAllowedHost("www.k18hair.com"), true)
  assert.equal(isAllowedHost("urban-alchemy.com"), true)
  assert.equal(isAllowedHost("www.wella.com"), true)
