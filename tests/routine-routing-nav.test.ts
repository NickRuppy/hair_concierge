...
test("middleware app-route helper matches chat and routine paths by route segment", () => {
...
test("middleware subscription helper matches chat, routine, and routine API paths by route segment", () => {
