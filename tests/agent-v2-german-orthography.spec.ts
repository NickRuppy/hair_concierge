...
const MODEL_FACING_SOURCE_FILES = [
  ...
  "src/lib/routines/personal-plan/application/german-copy.ts",
  "src/app/auth/page.tsx",
  "src/app/anwendung/layout.tsx",
  ...
  "src/components/application/product-application-block.tsx",
  "src/components/application/productless-step.tsx",
