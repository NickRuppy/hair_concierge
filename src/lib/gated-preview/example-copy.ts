...
export const GATED_EXAMPLE_COPY = {
  routine: {
    ...
    benefit: "Freigeschaltet: deine eigene Routine, mit deinen Produkten.",
  ...
  anwendung: {
    ...
    benefit: "Freigeschaltet: jeder Haartag, Schritt für Schritt.",
  ...
  chat: {
    ...
    benefit: "Freigeschaltet: deine Haarfragen, jederzeit beantwortet.",
