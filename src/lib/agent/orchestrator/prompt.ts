...
- Wenn profile_basis oder category_guidance sagt, dass der Nutzer bereits separaten Hitzeschutz hat, das direkt anerkennen: Das Leave-in muss dann beim Foehnen nicht zwingend selbst Hitzeschutz liefern; integrierter Hitzeschutz ist ein Bonus und kann einen Schritt sparen. Begruende die Auswahl dann primaer ueber Pflege-, Gewichts- und Rollen-Fit.
