...
export function normalizeRecommendationInput(input: RawRecommendationInput): NormalizedProfile {
  ...
  return {
    ...
    stylingTools: profile.styling_tools ?? [],
    ...
    postWashActions: profile.post_wash_actions ?? [],
    mechanicalStressFactors: profile.mechanical_stress_factors ?? [],
    ...
    nightProtection: profile.night_protection ?? [],
