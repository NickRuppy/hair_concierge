...
export const metadata: Metadata = LEGAL_PAGE_METADATA.impressum
          ...
          <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
            ...
            <section>
              ...
              <p>
                ...
                <br />
                Rechtsform: Limited Liability Company (LLC) nach dem Recht des Bundesstaates
                Delaware, USA
              </p>
            </section>
            ...
            <section>
              <h2 className="mb-2 font-medium text-foreground">
                Hinweis zu fachlichen Empfehlungen
              </h2>
              <p>
                Chaarlie ist kein medizinisches Produkt und ersetzt keine medizinische Beratung. Die
                Empfehlungen dienen ausschließlich der allgemeinen Haarpflege. Bei medizinischen
                Haar- oder Kopfhautproblemen wende dich an eine Dermatologin oder einen
                Dermatologen.
              </p>
            </section>
          </div>
