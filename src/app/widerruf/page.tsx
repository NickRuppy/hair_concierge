...
export const metadata: Metadata = LEGAL_PAGE_METADATA.widerruf
      ...
      <div className="flex flex-1 flex-col items-center px-4 py-16">
        <div className="w-full max-w-2xl space-y-8">
          ...
          <Link
            ...
            className="inline-flex min-h-11 items-center justify-center rounded-[11px] bg-primary px-6 py-2 text-[13px] font-semibold text-primary-foreground shadow hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            Vertrag widerrufen
          </Link>
          ...
          <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
            <section>
              ...
              <p className="mt-2">
                Dies gilt auch für den einmalig bezahlten persönlichen Haarplan. Zusätzlich gilt
                dafür eine 14-Tage-Geld-zurück-Garantie: Wenn Chaarlie für dich nicht hilfreich ist,
                erhältst du eine vollständige Rückerstattung. Deine gesetzlichen Rechte bleiben
                davon unberührt.
              </p>
            ...
            <section>
              ...
              <p>
                ...
                befindlichen digitalen Inhalten erlischt das Widerrufsrecht, wenn der Anbieter mit
                der Ausführung des Vertrags begonnen hat, nachdem du ausdrücklich zugestimmt hast,
                dass mit der Ausführung des Vertrags vor Ablauf der Widerrufsfrist begonnen wird,
                und du deine Kenntnis davon bestätigt hast, dass durch deine Zustimmung mit Beginn
                der Ausführung des Vertrags dein Widerrufsrecht erlischt.
              </p>
            </section>
