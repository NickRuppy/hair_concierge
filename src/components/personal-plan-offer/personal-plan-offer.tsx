    ...
    >
      ...
      >
        ...
        >
          ...
          <HairdresserProof />
          <BeforeAfterFigure className="mt-4 sm:mt-5 [@media(min-width:640px)_and_(max-height:700px)]:col-start-2 [@media(min-width:640px)_and_(max-height:700px)]:row-span-2 [@media(min-width:640px)_and_(max-height:700px)]:row-start-1 [@media(min-width:640px)_and_(max-height:700px)]:mt-0" />
        </section>
