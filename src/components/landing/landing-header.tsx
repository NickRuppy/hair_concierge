      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-3 px-4 py-3 sm:px-6 sm:py-3.5">
        ...
        <nav className="flex shrink-0 items-center gap-3 sm:gap-5">
          ...
          <Link
            href="/quiz"
            prefetch={false}
            className="hidden whitespace-nowrap rounded-[10px] bg-[var(--brand-coral)] px-3.5 py-2 text-sm font-semibold text-white transition-colors hover:bg-[var(--brand-coral-dark)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--brand-coral)] focus-visible:ring-offset-2 md:inline-block md:px-[18px] md:py-2.5"
          >
            Haaranalyse starten
          </Link>
        </nav>
