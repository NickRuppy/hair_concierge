...
function EmailCapture({
  ...
  onSaved: (leadId: string, email: string) => void | Promise<void>
...
export function PersonalPlanQuiz({
  ...
  // the flag on: their journey is the paid product, not the free tier.
