...
export function requestRoutineAttentionRefresh() {
  window.dispatchEvent(new Event(ROUTINE_ATTENTION_REFRESH_EVENT))
}

export function useRoutineAttention(enabled: boolean): boolean {
