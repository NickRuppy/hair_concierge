...
const ref = JSON.parse(readFileSync(new URL("../reference-key-v2/reference-key.json", import.meta.url)));
const blind = JSON.parse(readFileSync(new URL("../blind-v2/blind-review.json", import.meta.url)));
...
writeFileSync(new URL("./agreement-diff-v2.json", import.meta.url), JSON.stringify({ stats, disagreements, conf_deltas: rows.filter((r) => r.confOnly) }, null, 2));
...
writeFileSync(new URL("./agreement-diff-v2.md", import.meta.url), md);
