-- Extend the existing guarded executor with the exact reviewed E3 cohort.
-- Applied E1/E2 migrations and fingerprints remain unchanged.
...
BEGIN
  ...
  IF v_batch->>'schema_version' IS DISTINCT FROM 'scanner-existing-identifier-backfill-v1'
     OR v_batch->>'batch' NOT IN ('E1', 'E2', 'E3')
