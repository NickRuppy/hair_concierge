-- Stage 3 search readiness is catalog-completeness only.  Product fit remains
-- an owner-context decision after capture; the sole owner-aware search concern
-- is preventing a submitted catalog record from leaking to another owner.
