-- Extend the existing guarded executor with the exact reviewed E13 cohort.
-- Applied E1-E12 migrations and fingerprints remain unchanged.
...
ALTER TABLE public.scanner_identifier_backfill_batches
  ...
  CHECK (batch_name IN ('E1', 'E2', 'E3', 'E4', 'E5', 'E6', 'E7', 'E8', 'E9', 'E10', 'E11', 'E12', 'E13'));
...
BEGIN
  ...
  IF v_batch->>'schema_version' IS DISTINCT FROM 'scanner-existing-identifier-backfill-v1'
     OR v_batch->>'batch' NOT IN ('E1', 'E2', 'E3', 'E4', 'E5', 'E6', 'E7', 'E8', 'E9', 'E10', 'E11', 'E12', 'E13')
