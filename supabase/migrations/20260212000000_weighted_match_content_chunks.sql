-- Add authority-weighted scoring + source_types array filter to match_content_chunks.
-- Tier 1 (1.4x): book, product_list — verified, curated content
-- Tier 2 (1.0x): qa, narrative — structured supplementary
-- Tier 3 (0.8x): transcript, live_call, product_links — conversational
