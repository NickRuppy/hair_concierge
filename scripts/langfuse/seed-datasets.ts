  ...
  for (const candidate of selection) {
    ...
    await langfuse.api.datasetItems.create({
      ...
      metadata: {
        ...
        trace_version: candidate.traceVersion,
        response_composition_path: candidate.responseCompositionPath,
        prompt_kind: candidate.promptKind,
        engine_damage_level: candidate.engineDamageLevel,
        engine_repair_priority: candidate.engineRepairPriority,
        engine_actions: candidate.engineActions,
        selected_products: candidate.selectedProducts,
        failure_bucket: candidate.failureBucket,
